...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex justify-end items-center ml-3 md:mr-36 mb-2'>
...
<div onClick={() => setNav(!Nav)} className="cursor-pointer  flex justify-center items-center  text-gray-600 md:hidden">
{Nav ? <FaTimes size={50} /> : <FaBars size={50} />}
</div>

{Nav && (
<ul className="flex flex-col duration-300 justify-center  items-center scroll-m-0 top-0 left-0 w-full h-screen text-gray-600">
  {links.map(({ id, link }) => (
